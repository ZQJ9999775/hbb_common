...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "zhangquanjie@123".to_string());
        RwLock::new(map)
};
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.zhangquanjie.cn"];
pub const RS_PUB_KEY: &str = "v2JzAPVgwPgDiUBVmNCiU0nfrFEp8rE0cv5MGQmvoQI=";
